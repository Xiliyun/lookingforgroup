var username="estheremiliefranck";
...
function getLocation(jData) {
  ...
  if (postalcodes.length > 1) {
    ...
    if (postalcodes.length == 1) {
      ...
      city.value = postalcodes[0].placeName;
      region.value= postalcodes[0].adminName1;
...
function suggestBoxMouseDown(obj) {
  ...
  var latitude = document.getElementById("latitude");
  var longitude = document.getElementById("longitude");
  city.value = postalcodes[obj].placeName;
  region.value= postalcodes[obj].adminName1;
...
function postalCodeLookup() {
  ...
  request = 'http://api.geonames.org/postalCodeLookupJSON?postalcode=' + postalcode  + '&country=' + country  + '&callback=getLocation' + '&style=long&username='+username;
